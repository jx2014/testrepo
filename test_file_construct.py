from Intel_ICG_File_Construct.file_construct import fc

daily_folder = '20140715'
irci = '493'
#package_date = '20140715' #most of the time you don't need this
package_hr = '1500'
remote_path = r'Z:\tartest\viedifw\day'
